      ...
      <div className="container mx-auto px-6 max-w-[1000px]">
        ...
        <div className="flex flex-col max-w-[1010px] mx-auto lg:flex-row items-center mb-32">
          ...
          <div className="w-full lg:w-1/2 relative mb-12 lg:mb-0">
            <div className="rounded-full bg-[#6DE1A1] w-[520px] h-[520px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-0"></div>
            <div className="relative z-10 flex justify-center">
              <motion.img
                src={wallet}
                alt="Stake Wallet interface"
                className="relative z-10 max-w-full h-auto w-[320px]"
        ...
        <div className="flex flex-col mx-auto max-w-[1004px] lg:flex-row-reverse items-center mb-32">
          ...
          <div className="w-full lg:w-1/2 pr-0 lg:pr-12">
            ...
            <p className="text-[17px] leading-[27px] font-normal text-[#5A616E] mb-8">
              Watch your investment grow as property values appreciate and funds
              near maturity
            </p>
            ...
            <div className="flex flex-col md:flex-row gap-18 mb-4">
              <div>
                <p className="flex items-center">
                  <span className="text-3xl font-bold text-[#121726]">350</span>
                  <span className="text-3xl font-bold text-[#6DCB93]">+</span>
                </p>
                <p className="text-[#80858F] font-semibold text-[16px]">Properties Funded <br/> Since 2021</p>
              </div>
              <div>
                <p className="flex items-center">
                  <span className="text-3xl font-bold text-[#121726]">
        ...
        <div className=" flex flex-col mx-auto max-w-[1004px] lg:flex-row items-center">
          {/* Phone Image Container - Left */}
          <div className="w-full lg:w-1/2 relative mb-12 lg:mb-0">
            <div className="rounded-full bg-[#6DCB93] w-[520px] h-[520px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-0"></div>
            <div className="relative z-10 flex justify-center">
              <motion.img
                src={studio}
          ...
          <div className="w-full lg:w-1/2 pl-0 lg:pl-12">
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-4">
              <div>
                ...
                <p className="text-[#80858F] font-semibold text-[16px]">Properties Fully Exited</p>
              </div>
              <div>
                <p className="flex items-center">
                  <span className="text-3xl font-bold text-[#121726]">
                  ...
                  <span className="text-3xl font-bold text-[#6DCB93]">M+</span>
                </p>
                <p className="text-[#80858F] font-semibold text-[16px]">Traded During Exit Windows</p>
              </div>
            </div>
          </div>
        </div>
